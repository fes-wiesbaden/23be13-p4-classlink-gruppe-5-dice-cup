...
export class PasswordResetControllerService extends BaseService {
   ...
   */
  public commit(
    passwordResetCommitRequestDto: PasswordResetCommitRequestDto,
    observe?: 'body',
  ...
  public commit(
    ...
    if (passwordResetCommitRequestDto === null || passwordResetCommitRequestDto === undefined) {
      throw new Error(
        'Required parameter passwordResetCommitRequestDto was null or undefined when calling commit.',
      );
    }
   ...
   */
  public create1(
    passwordResetCreateRequestDto: PasswordResetCreateRequestDto,
    observe?: 'body',
    reportProgress?: boolean,
    options?: {
      httpHeaderAccept?: '*/*';
  ...
  public create1(
    ...
    if (passwordResetCreateRequestDto === null || passwordResetCreateRequestDto === undefined) {
      throw new Error(
        'Required parameter passwordResetCreateRequestDto was null or undefined when calling create1.',
      );
    }
    ...
    const { basePath, withCredentials } = this.configuration;
    return this.httpClient.request<PasswordResetCreateResponseDto>(
      'post',
   ...
   */
  public validate1(
    passwordResetValidateRequestDto: PasswordResetValidateRequestDto,
    observe?: 'body',
    reportProgress?: boolean,
    options?: {
      httpHeaderAccept?: '*/*';
  ...
  public validate1(
    ...
    if (passwordResetValidateRequestDto === null || passwordResetValidateRequestDto === undefined) {
      throw new Error(
        'Required parameter passwordResetValidateRequestDto was null or undefined when calling validate1.',
      );
    }
    ...
    const { basePath, withCredentials } = this.configuration;
    return this.httpClient.request<PasswordResetValidateResponseDto>(
      'post',
      `${basePath}${localVarPath}`,
      {
        context: localVarHttpContext,
