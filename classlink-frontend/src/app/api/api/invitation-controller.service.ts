...
export class InvitationControllerService extends BaseService {
  ...
  public create(
    ...
    if (createInviteRequestDto === null || createInviteRequestDto === undefined) {
      throw new Error(
        'Required parameter createInviteRequestDto was null or undefined when calling create.',
      );
    }
   ...
   */
  public redeem(
    inviteRedeemRequestDto: InviteRedeemRequestDto,
    observe?: 'body',
    reportProgress?: boolean,
    options?: {
      httpHeaderAccept?: '*/*';
  ...
  public redeem(
    ...
    if (inviteRedeemRequestDto === null || inviteRedeemRequestDto === undefined) {
      throw new Error(
        'Required parameter inviteRedeemRequestDto was null or undefined when calling redeem.',
      );
    }
   ...
   */
  public validate(
    inviteValidationRequestDto: InviteValidationRequestDto,
    observe?: 'body',
    reportProgress?: boolean,
    options?: {
      httpHeaderAccept?: '*/*';
  ...
  public validate(
    ...
    if (inviteValidationRequestDto === null || inviteValidationRequestDto === undefined) {
      throw new Error(
        'Required parameter inviteValidationRequestDto was null or undefined when calling validate.',
      );
    }
    ...
    const { basePath, withCredentials } = this.configuration;
    return this.httpClient.request<InviteValidationResponseDto>(
      'post',
